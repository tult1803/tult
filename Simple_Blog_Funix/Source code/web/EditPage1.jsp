        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <div class="post-preview">
                    ...
                    <textarea name="title"  style="width: 100%;height: 50px;"><% out.print(control.list.get(1));%></textarea>
                    <h3 class="post-subtitle">Sub Content</h3>
                    <textarea name="subcontent"  style="width: 100%;height: 200px;"><% out.print(control.list1.get(1));%></textarea>
                    <h3 class="post-subtitle"> Main Content </h3>
                        <textarea name="content"  style="width: 100%;height: 500px;"><% out.print(control.list2.get(1));%></textarea>
                    <h3 class="post-subtitle"> Author </h3>       
                    <textarea name="author"  style="width: 100%;height: 40px;"><% out.print(control.list4.get(1));%></textarea>
